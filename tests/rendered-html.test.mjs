...
test("keeps the prototype self-contained", async () => {
  ...
  assert.match(page, /new-growth-icon/);
  ...
  assert.match(wasmSimulation, /WASM_RUNTIME_VERSION = 5/);
  ...
  assert.match(techTree, /New Growth/);
  assert.match(techTree, /icon: "new-growth"/);
